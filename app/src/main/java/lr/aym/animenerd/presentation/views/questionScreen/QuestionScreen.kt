...
import lr.aym.animenerd.presentation.views.questionScreen.dialogs.CongratsDialog
...
fun QuestionScreen(
    ...
    val showEarnPointsDialog = viewModel.showEarnPointsDialog.collectAsStateWithLifecycle()
    ...
    Scaffold(modifier = Modifier.fillMaxSize(),
        topBar = {
            QuestionTopBar(
                ...
                onWatchAddClick = viewModel::onEarnPointsClick
            )
        },
        bottomBar = {
            AdmobBanner()
        ...
        if (showRevealLetterDialog.value) {
            PointsActionDialog(
                ...
                text = stringResource(id = R.string.reveal_letter_error_dialog),
        ...
        if (showEarnPointsDialog.value){
            PointsActionDialog(
                showLoadingProgressBar = watchRewardedAdClicked,
                text = stringResource(id = R.string.earn_points_text),
                onDismissClick = viewModel::onDismissEarnPointsDialogClick,
                onWatchAdsClick = {
                onRewardedAdClick()
                }
            )
